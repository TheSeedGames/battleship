...
#---------------------------------------------------------------------------------
#LIBS	:= -ldsnifi9 -lgl2d -lfilesystem -lfat -lnds9
LIBS	:= -lgl2d -lfilesystem -lfat -lnds9
...
$(BUILD):
	@[ -d $@ ] || mkdir -p $@
	@make BUILDDIR=`cd $(BUILD) && pwd` --no-print-directory -C $(BUILD) -f $(CURDIR)/Makefile && rm -rf $(TARGET).elf
